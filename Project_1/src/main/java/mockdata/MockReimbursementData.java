...
//		MockReimbursementData reimbursementData = new MockReimbursementData();
		...
		Reimbursement REIMBURSEMENT_APROVED_1 = new Reimbursement( 3, 1,  3,  "Free lunch offer from Sean", ReimbursementType.Food, Status.Approved, 25.00);
		Reimbursement REIMBURSEMENT_APROVED_2 = new Reimbursement( 4, 2,  4,  "2-night hotel stay near Orlando Office for visit", ReimbursementType.Lodging, Status.Approved, 300.00);
